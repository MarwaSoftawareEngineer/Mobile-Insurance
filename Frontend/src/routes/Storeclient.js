            ...
            <div class="products">
              <article class="product">
                <div class="product__imgbox">
                  <img
                    src="https://netology-code.github.io/mq-homeworks/adaptive-layout/product-list/img/prod1.png"
                    class="product__preview"
                    alt="Apple iPhone 7"
                  />
                </div>
                <div class="product__body">
                  <h3 class="product__name">Apple iPhone 7 32Gb Black</h3>
                  <span class="product__price">950 Dt</span>
                </div>
              </article>
              <article class="product">
                <div class="product__imgbox">
                  <img
                    src="https://netology-code.github.io/mq-homeworks/adaptive-layout/product-list/img/prod2.png"
                    class="product__preview"
                    alt="Apple iPhone 8"
                  />
                </div>
                <div class="product__body">
                  <h3 class="product__name">Apple iPhone 8 64Gb Space Gray</h3>
                  <span class="product__price">1020 Dt</span>
                </div>
              </article>
              <article class="product">
                <div class="product__imgbox">
                  <img
                    src="https://netology-code.github.io/mq-homeworks/adaptive-layout/product-list/img/prod3.png"
                    class="product__preview"
                    alt="Apple iPhone 5S"
                  />
                </div>
                <div class="product__body">
                  <h3 class="product__name">Apple iPhone 5S 16Gb Space Gray</h3>
              ...
              <article class="product">
                <div class="product__imgbox">
                  <img
                    src="https://netology-code.github.io/mq-homeworks/adaptive-layout/product-list/img/prod4.png"
                    class="product__preview"
                    alt="Apple iPhone 8"
                  />
                </div>
                <div class="product__body">
                  <h3 class="product__name">Apple iPhone 8 64Gb Gold</h3>
                  <span class="product__price">1200 Dt</span>
                </div>
              </article>
              <article class="product">
                <div class="product__imgbox">
                  <img
                    src="https://netology-code.github.io/mq-homeworks/adaptive-layout/product-list/img/prod5.png"
                    class="product__preview"
                    alt="Apple iPhone SE"
                  />
                </div>
                <div class="product__body">
                  <h3 class="product__name">
                    Apple iPhone SE 128Gb Space Gray
                  </h3>
                  <span class="product__price">1020 Dt</span>
                </div>
              </article>
              <article class="product">
                <div class="product__imgbox">
                  <img
                    src="https://netology-code.github.io/mq-homeworks/adaptive-layout/product-list/img/prod6.png"
                    class="product__preview"
                    alt="Samsung Galaxy Note 8"
                  />
                </div>
                <div class="product__body">
                  <h3 class="product__name">Samsung Galaxy Note 8 64Gb</h3>
                  <span class="product__price">1020 Dt</span>
                </div>
              </article>
              <article class="product">
                <div class="product__imgbox">
                  <img
                    src="https://netology-code.github.io/mq-homeworks/adaptive-layout/product-list/img/prod7.png"
                    class="product__preview"
                ...
                <div class="product__body">
                  <h3 class="product__name">
                    Samsung Galaxy S7 4G 32Gb DS Black
                  </h3>
                  <span class="product__price">1020 Dt</span>
                </div>
              </article>
              <article class="product">
                <div class="product__imgbox">
                  <img
                    src="https://netology-code.github.io/mq-homeworks/adaptive-layout/product-list/img/prod8.png"
                    class="product__preview"
                ...
                <div class="product__body">
                  <h3 class="product__name">
                    Samsung Galaxy A5 (2017) 4G 32Gb Black
                  </h3>
                  <span class="product__price">1020 Dt</span>
                </div>
              </article>
              <article class="product">
                <div class="product__imgbox">
                  <img
                    src="https://netology-code.github.io/mq-homeworks/adaptive-layout/product-list/img/prod9.png"
                    class="product__preview"
                    alt="Samsung Galaxy S8"
                  />
                </div>
                <div class="product__body">
                  <h3 class="product__name">Samsung Galaxy S8 4G 64Gb Black</h3>
                  <span class="product__price">1020 Dt</span>
                </div>
              </article>
              <article class="product">
                <div class="product__imgbox">
                  <img
                    src="https://netology-code.github.io/mq-homeworks/adaptive-layout/product-list/img/prod10.png"
                    class="product__preview"
                    alt="Samsung Galaxy A5"
                  />
                </div>
                <div class="product__body">
                  <h3 class="product__name">
                    Samsung Galaxy A5 (2017) 4G 32Gb Gold
                  </h3>
                  <span class="product__price">1020 Dt</span>
                </div>
              </article>
